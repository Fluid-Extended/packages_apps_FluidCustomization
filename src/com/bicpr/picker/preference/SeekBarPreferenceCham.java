package com.bicpr.picker.preference;
...
public class SeekBarPreferenceCham extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    private static final String TITANIUMNS = "http://schemas.android.com/apk/res-auto";
    ...
    private void setValuesFromXml(AttributeSet attrs, Context context) {
        ...
        mUnitsLeft = getAttributeStringValue(attrs, TITANIUMNS, "unitsLeft", "");
        mUnitsRight = getAttributeStringValue(attrs, TITANIUMNS, "unitsRight", "");
        ...
        try {
            String newInterval = attrs.getAttributeValue(TITANIUMNS, "interval");
            if(newInterval != null)
